...
<body>
    ...
    <div class="card">
        <div class="card-header" style="display: flex;justify-content:space-between">
            ...
            <a href="#" style="width: 200px;" class="btn btn-block btn-primary" data-toggle="modal" data-target="#addProjectModal">
            ...
            <tbody>
                @forelse ($projects as $index => $project)
                    <tr>
                        ...
                        <td>
                            @if ($project->image)
                                <img src="{{ asset('files/' . $project->image) }}" alt="{{ $project->title }}"

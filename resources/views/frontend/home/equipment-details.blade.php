    ...
    <div class="container-fluid bg-breadcrumb"
        ...
        <div class="container text-center py-5" style="max-width: 900px;">
            ...
            <ol class="breadcrumb d-flex justify-content-center mb-0 wow fadeInDown" data-wow-delay="0.3s">
                ...
                <li class="breadcrumb-item"><a href="{{ route('frontend.home.equipments','all') }}" class="text-light">Equipment</a></li>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-6 wow fadeInRight" data-wow-delay="0.4s">
                ...
                <ul class="list-group list-group-flush mb-4">
                    <li class="list-group-item bg-dark text-white border-warning"><strong>Category:</strong> {{ $equipment->category }}</li>
                    <li class="list-group-item bg-dark text-white border-warning"><strong>Condition:</strong> {{ ucfirst($equipment->condition) }}</li>
                    <li class="list-group-item bg-dark text-white border-warning"><strong>Year:</strong> {{ $equipment->year }}</li>

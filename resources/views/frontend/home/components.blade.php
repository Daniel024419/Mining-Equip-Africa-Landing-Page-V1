    ...
    <div class="py-5 container-fluid bg-dark">
        <div class="container py-5">
            ...
            <div class="row g-4">
                            ...
                            <div class="component-img position-relative">
                                @if ($component->images->isNotEmpty())
                                    <img src="{{ asset('files/' . ($component->images->first()->path ?? 'default.png')) }}"
                                        class="transition-transform img-fluid w-100 hover-scale" alt="{{ $component->name }}"
                                ...
                                <div class="top-0 px-3 py-1 m-3 component-badge bg-warning text-dark position-absolute end-0 rounded-pill fw-bold text-uppercase">
                ...
                @empty
                    <h2 class="text-white">No {{ request('condition') }} components matching the condition is found</h2>
                @endforelse
